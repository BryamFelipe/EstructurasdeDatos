...
public class Nivel3 extends javax.swing.JFrame {
    ...
    String[]preguntas = {
        ...
        "¿Choose the correct form of the verb to complete the sentence'He_____ to the store yesterday'?",
        "¿Wthat is the plural form of 'child'?",
    ...
    String[][]opciones = {
        ...
        {"Go", "Goes", "Went", "Gone"},
        {"Childs", "Children", "Childen", "Childe"},
        {"Well", "Gooder", "Better", "Best"},
        {"Farest", "Farer", "More far", "Farthest"},
    };
    ...
    private void verRespuesta(){
        ...
        if(respuestas[index]!= 'D'){
            JB_opc4.setBackground(Color.RED);
        }
    ...
    private void initComponents() {
        ...
        jPanel1.add(JL_imagen, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 680, 160));
